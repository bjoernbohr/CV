          ...
          return (
            ...
            >
              ...
              <div className={'title'}>
                ...
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="10 10 45 45"><path data-name="layer1" d="M25.004 16a3 3 0 0 0 0 6h12.752l-20.87 20.87a3 3 0 0 0 4.243 4.242L42 26.242v12.557a3 3 0 0 0 6 0V16z" fill="none" stroke="#202020" stroke-miterlimit="10" stroke-width="2" ></path></svg>
              </div>
            
              <h3 className={'subtitle'}>{val['SUB']}</h3>
              <img src={val['IMG']} alt="" /> {/* Hier war ein Tippfehler (a) */}
            </div>
          );
        });
      })}
